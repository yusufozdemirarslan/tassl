...
// the accessibility tree so nothing else is read out. Bar heights match the type scale's line
// heights (h1 44, title 32, body 22) so the real page lands without a shift.
