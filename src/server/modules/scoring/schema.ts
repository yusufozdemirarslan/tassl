...
export const bandViewSchema = z.object({
  ...
  /**
   * Who decided, and when. Both are on the reviewer's view because the replay names the colleague
   * whose decision a reviewer is looking at. Neither reaches a student: the debrief's own
   * projection carries the band and the note.
   */
