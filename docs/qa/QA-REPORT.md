...
the live model, and the demo state was restored afterwards. Sixty-nine defects were found and fixed
...
Sixty-nine defects were found and fixed. Every one has a row in `docs/qa/FIXED-ISSUES.md` under the
...
| What | Where |
|---|---|
| Every defect, with symptom, root cause, fix and guarding test | `docs/qa/FIXED-ISSUES.md`, 69 rows |
