...
the live model, and the demo state was restored afterwards. Sixty-seven defects were found and fixed
...
Sixty-seven defects were found and fixed. Every one has a row in `docs/qa/FIXED-ISSUES.md` under the
...
| What | Where |
|---|---|
| Every defect, with symptom, root cause, fix and guarding test | `docs/qa/FIXED-ISSUES.md`, 67 rows |
