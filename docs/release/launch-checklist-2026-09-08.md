...
| 10 | Load test (NFR-014, D-102) | not run | k6 against a preview with `VERCEL_AUTOMATION_BYPASS_SECRET`. |
...
| 16 | Cross-browser E2E | not run | `pnpm test:e2e` across chromium, firefox and webkit, locally. CI runs chromium only. |
