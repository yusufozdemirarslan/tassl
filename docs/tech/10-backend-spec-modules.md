...
Repository: `upsertRunClaim`, `listRunClaims`, `findRunClaim`, `setStance`, `insertAction`, `listActions`, `insertEscalation`, `countEscalations` (every row of the run, not the `counts_against_limit` subset — D-328), `updateReliedOn`.
