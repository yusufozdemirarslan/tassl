...
async function setup() {
  ...
  const instructorUser = await f.createUser('frame-instructor', { platformRole: 'instructor' })
  ...
  const editorUser = await f.createUser('frame-editor', { platformRole: 'tassl_scenario_editor' })
